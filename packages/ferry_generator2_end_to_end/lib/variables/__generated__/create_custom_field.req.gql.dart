...
class GCreateCustomFieldReq
  ...
  GCreateCustomFieldReq copyWith({
    _i3.GCreateCustomFieldVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GCreateCustomFieldData? Function(
      _i2.GCreateCustomFieldData?,
      _i2.GCreateCustomFieldData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GCreateCustomFieldData? optimisticResponse,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other is GCreateCustomFieldReq &&
  ...
  @override
  String toString() {
    return 'GCreateCustomFieldReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
