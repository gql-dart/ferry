...
import 'package:ferry_generator2_end_to_end/edge_cases/__generated__/search_with_starship.ast.gql.dart'
    as _i5;
...
class GSearchWithStarshipReq
    implements _i1.OperationRequest<_i2.GSearchWithStarshipData, Null> {
  GSearchWithStarshipReq({
  ...
  final _i2.GSearchWithStarshipData? Function(
    _i2.GSearchWithStarshipData?,
    _i2.GSearchWithStarshipData?,
  )? updateResult;

  final _i2.GSearchWithStarshipData? optimisticResponse;
  ...
  static const _i4.DocumentNode _document =
      _i4.DocumentNode(definitions: [_i5.SearchWithStarship]);

  static const _i3.Operation _operation = _i3.Operation(
    document: _document,
    operationName: 'SearchWithStarship',
  );
  ...
  _i2.GSearchWithStarshipData? parseData(Map<String, dynamic> json) =>
      _i2.GSearchWithStarshipData.fromJson(json);

  Map<String, dynamic> varsToJson() => const <String, dynamic>{};

  Map<String, dynamic> dataToJson(_i2.GSearchWithStarshipData data) =>
      data.toJson();

  _i1.OperationRequest<_i2.GSearchWithStarshipData, Null> transformOperation(
  ...
  GSearchWithStarshipReq copyWith({
    _i3.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GSearchWithStarshipData? Function(
      _i2.GSearchWithStarshipData?,
      _i2.GSearchWithStarshipData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GSearchWithStarshipData? optimisticResponse,
