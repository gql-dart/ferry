...
import 'package:ferry_generator2_end_to_end/edge_cases/__generated__/posts_by_likes.ast.gql.dart'
    as _i6;
import 'package:ferry_generator2_end_to_end/edge_cases/__generated__/posts_by_likes.data.gql.dart'
    as _i2;
...
class GPostsByLikesReq
    implements
        _i1.OperationRequest<_i2.GPostsByLikesData, _i3.GPostsByLikesVars> {
  GPostsByLikesReq({
    required this.vars,
  ...
  final _i3.GPostsByLikesVars vars;

  final _i4.Operation operation;

  final String? requestId;

  final _i2.GPostsByLikesData? Function(
    _i2.GPostsByLikesData?,
    _i2.GPostsByLikesData?,
  )? updateResult;

  final _i2.GPostsByLikesData? optimisticResponse;
  ...
  static const _i5.DocumentNode _document =
      _i5.DocumentNode(definitions: [_i6.PostsByLikes]);

  static const _i4.Operation _operation = _i4.Operation(
    document: _document,
    operationName: 'PostsByLikes',
  );
  ...
  _i2.GPostsByLikesData? parseData(Map<String, dynamic> json) =>
      _i2.GPostsByLikesData.fromJson(json);

  Map<String, dynamic> varsToJson() => vars.toJson();

  Map<String, dynamic> dataToJson(_i2.GPostsByLikesData data) => data.toJson();
  ...
  GPostsByLikesReq copyWith({
    _i3.GPostsByLikesVars? vars,
    _i4.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GPostsByLikesData? Function(
      _i2.GPostsByLikesData?,
      _i2.GPostsByLikesData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GPostsByLikesData? optimisticResponse,
