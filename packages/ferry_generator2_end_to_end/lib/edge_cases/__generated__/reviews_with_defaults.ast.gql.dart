...
const ReviewsWithDefaults = _i1.OperationDefinitionNode(
  type: _i1.OperationType.query,
  name: _i1.NameNode(value: 'ReviewsWithDefaults'),
  variableDefinitions: [
    ...
    _i1.VariableDefinitionNode(
      ...
      defaultValue: _i1.DefaultValueNode(
          value: _i1.ListValueNode(values: [_i1.IntValueNode(value: '5')])),
      directives: [],
    ),
  ],
  directives: [],
...
const document = _i1.DocumentNode(definitions: [ReviewsWithDefaults]);
