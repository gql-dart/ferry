...
import 'package:ferry_generator2_end_to_end/edge_cases/__generated__/numeric_value.ast.gql.dart'
    as _i5;
...
class GNumericValueReq
    implements _i1.OperationRequest<_i2.GNumericValueData, Null> {
  GNumericValueReq({
  ...
  final _i2.GNumericValueData? Function(
    _i2.GNumericValueData?,
    _i2.GNumericValueData?,
  )? updateResult;

  final _i2.GNumericValueData? optimisticResponse;
  ...
  static const _i4.DocumentNode _document =
      _i4.DocumentNode(definitions: [_i5.NumericValue]);

  static const _i3.Operation _operation = _i3.Operation(
    document: _document,
    operationName: 'NumericValue',
  );
  ...
  _i2.GNumericValueData? parseData(Map<String, dynamic> json) =>
      _i2.GNumericValueData.fromJson(json);

  Map<String, dynamic> varsToJson() => const <String, dynamic>{};

  Map<String, dynamic> dataToJson(_i2.GNumericValueData data) => data.toJson();

  _i1.OperationRequest<_i2.GNumericValueData, Null> transformOperation(
  ...
  GNumericValueReq copyWith({
    _i3.Operation? operation,
    String? requestId,
    bool requestIdIsSet = false,
    _i2.GNumericValueData? Function(
      _i2.GNumericValueData?,
      _i2.GNumericValueData?,
    )? updateResult,
    bool updateResultIsSet = false,
    _i2.GNumericValueData? optimisticResponse,
  ...
  @override
  String toString() {
    return 'GNumericValueReq(vars: $vars, operation: $operation, requestId: $requestId, updateResult: $updateResult, optimisticResponse: $optimisticResponse, updateCacheHandlerKey: $updateCacheHandlerKey, updateCacheHandlerContext: $updateCacheHandlerContext, fetchPolicy: $fetchPolicy, executeOnListen: $executeOnListen, context: $context)';
  }
}
