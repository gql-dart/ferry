...
class CacheDeduplicationStrategy extends EnumClass {
  ...
  static Serializer<CacheDeduplicationStrategy> get serializer => _$cacheDeduplicationStrategySerializer;

  static const CacheDeduplicationStrategy none = _$none;
  static const CacheDeduplicationStrategy onNormalizedObjects = _$onNormalizedObjects;
