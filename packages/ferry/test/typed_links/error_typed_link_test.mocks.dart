...
class _FakeTypedLink_0 extends _i1.SmartFake implements _i2.TypedLink {
  _FakeTypedLink_0(Object parent, Invocation parentInvocation)
...
class MockTypedLink extends _i1.Mock implements _i2.TypedLink {
  ...
  _i4.Stream<_i5.OperationResponse<TData, TVars>> request<TData, TVars>(
      ...
      (super.noSuchMethod(Invocation.method(#request, [request, forward]),
              returnValue:
                  _i4.Stream<_i5.OperationResponse<TData, TVars>>.empty())
